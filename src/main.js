...
class AcodePluginSnippets {
    constructor() {
        ...
        // Adicionando ouvinte para detectar mudanças no editor
    ...
    initializeAutocompletion(snippets = []) {
        ...
        const react_Completers = {
            getCompletions(editor, session, pos, prefix, callback) {
                ...
                const projectSnippets = snippets.filter(s =>
                    s.fileTypes.includes(typeCurrentFile)
                ); // Filtra os snippets relevantes para o tipo do arquivo atual
